# Consuming Envia Daki Design System in Expo apps

Read `artifacts/envia-daki-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/envia-daki-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/envia-daki-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/envia-daki-design-system/lib/native-theme";
import { useColors } from "@workspace/envia-daki-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/envia-daki-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/envia-daki-design-system/components/native/badge";
import { Button } from "@workspace/envia-daki-design-system/components/native/button";
import { Card } from "@workspace/envia-daki-design-system/components/native/card";
```
...
Import and render
`@workspace/envia-daki-design-system/components/native/button`, then run Expo
