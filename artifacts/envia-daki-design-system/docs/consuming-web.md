# Consuming Envia Daki Design System in web apps

Read `artifacts/envia-daki-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/envia-daki-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/envia-daki-design-system/styles.css";
```
...
`node_modules/@workspace/envia-daki-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/envia-daki-design-system/components/ui/button";
import { cn } from "@workspace/envia-daki-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/envia-daki-design-system/hooks/use-toast";
```
...
`@workspace/envia-daki-design-system/components/ui/button`. Run the app's typecheck
