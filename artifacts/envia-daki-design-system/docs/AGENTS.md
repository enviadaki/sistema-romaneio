# Envia Daki Design System design system
...
workspace package (`@workspace/envia-daki-design-system`): other artifacts depend
...
`@workspace/envia-daki-design-system/components/...`. Never use a `@/` alias inside
...
The initial source-backed pilot is documented in
`docs/references/component-inventory.md`. Its references live under
`docs/references/components/` and must name the source component, observed
variants, important states, and usage guidance. Expand the pilot only after
the current preview has been reviewed.
...
for `@workspace/envia-daki-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/envia-daki-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/envia-daki-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/envia-daki-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/envia-daki-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/envia-daki-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/envia-daki-design-system/docs/migrating-expo.md`
