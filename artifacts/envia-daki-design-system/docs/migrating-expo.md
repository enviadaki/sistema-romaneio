# Migrating Expo UI to Envia Daki Design System

Read `artifacts/envia-daki-design-system/docs/AGENTS.md` and
`artifacts/envia-daki-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/envia-daki-design-system/lib/native-theme` and
  `@workspace/envia-daki-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/envia-daki-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/envia-daki-design-system` and retains only
