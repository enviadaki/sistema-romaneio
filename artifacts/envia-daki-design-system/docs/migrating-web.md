# Migrating web UI to Envia Daki Design System

Read `artifacts/envia-daki-design-system/docs/AGENTS.md` and
`artifacts/envia-daki-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/envia-daki-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/envia-daki-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/envia-daki-design-system/hooks/use-toast`
